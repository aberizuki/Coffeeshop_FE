    ...
    <>
      ...
      <main className="container">
        ...
        <section className="product">
          ...
          <div className="flex">
            <Link to="/ProductAdminAdd">
              <button className="btn btn-secondary btn-center m-1">
                + Add Product
              </button>
            </Link>
          </div>
            ...
            {data.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <br />
                  <div>
                    <button className="mr-5 btn-danger btn-ss">EDIT</button>
                    <button
                      onClick={() => {
                        confirmDelete(item.id);
                      }}
                      className="btn-success btn-ss"
                    >
                      DELETE
                    </button>
                  </div>
